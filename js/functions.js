...
const scenario3 = new scenario(65, "Inter", "Dry", [new tyre("W",2,60), new tyre("H",53,5), new tyre("M",24,3), new tyre("S",18,0), new tyre("I",5,60)], '<p>Well done for choosing the right tyre! The soft is the optimum selction due to the weather being dry and only 5 laps remaining in the race. In this scenario you want the fastest tyre as durability is not an important factor with 5 laps remaining.</p>','<p>The soft is the optimum selction due to the weather being dry and only 5 laps remaining in the race. In this scenario you want the fastest tyre as durability is not an important  factor with 5 laps remaining.</p>');
